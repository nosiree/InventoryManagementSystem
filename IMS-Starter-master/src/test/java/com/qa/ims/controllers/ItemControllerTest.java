...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String itemName = "chair";
		final Double itemValue = 30.0;
		final Item created = new Item(itemName, itemValue);

		Mockito.when(utils.getString()).thenReturn(itemName);
		Mockito.when(utils.getDouble()).thenReturn(itemValue);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "cup", 20.0));
	...
	public void testUpdate() {
		Item updated = new Item(1L, "mug", 10.0);
